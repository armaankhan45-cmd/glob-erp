    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="card">
        ...
        {items.map((item, idx) => (
          <div key={idx} className="grid grid-cols-7 gap-2 mb-2 items-end">
            ...
            <div><input value={item.hsn_code} onChange={e => updateItem(idx, 'hsn_code', e.target.value)} className="input-field text-sm" placeholder="HSN" /></div>
      ...
      <div className="card">
        <div className="max-w-sm ml-auto space-y-2 text-sm">
          ...
          <hr />
          <div className="flex justify-between font-bold text-base"><span>TOTAL</span><span>₹{calculated.total.toFixed(2)}</span></div>
        </div>
      </div>
