  ...
  return (
    <main className="flex min-h-screen w-full p-2 lg:h-screen lg:overflow-hidden lg:p-4" style={{ background: '#06080f' }}>
      <div className="hidden lg:flex w-[52%] relative flex-col items-center justify-end pb-32 px-12 rounded-3xl overflow-hidden" style={{ background: '#06080f' }}>
        <div className="orb" style={{ width: 400, height: 400, background: 'radial-gradient(circle, rgba(6,182,212,0.3), transparent 70%)', top: '5%', left: '5%', animation: 'orbMove1 20s ease-in-out infinite' }}></div>
        ...
        <div className="z-10 w-full max-w-xs space-y-8">
          <div className="flex items-center gap-2.5 mb-8">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center btn-primary" style={{ padding: 0, minWidth: 32, height: 32 }}><span className="text-white font-extrabold text-sm">G</span></div>
            <span className="text-xl font-bold tracking-tight text-white">Glob ERP</span>
          </div>
          <h2 className="text-4xl font-bold tracking-tight text-white">Welcome to <span className="accent-text">Nebula</span></h2>
          ...
          <div className="space-y-2 mt-6">
            <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl btn-primary"><div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold" style={{ background: 'rgba(0,0,0,0.2)' }}>1</div><span className="text-sm font-medium">Sign in to your account</span></div>
            <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)', color: 'rgba(255,255,255,0.4)' }}><div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold" style={{ background: 'rgba(255,255,255,0.1)' }}>2</div><span className="text-sm font-medium">Configure your workspace</span></div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-12 lg:py-6 px-4 sm:px-12 lg:px-16 xl:px-24 overflow-y-auto lg:overflow-hidden">
        <div className="w-full max-w-xl space-y-8 lg:space-y-6 sm:space-y-10" style={{ animation: 'slideUp 0.8s ease-out' }}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button type="button" className="flex items-center justify-center gap-3 h-12 px-4 text-sm font-medium rounded-xl" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.6)' }}>G Google</button>
            <button type="button" className="flex items-center justify-center gap-3 h-12 px-4 text-sm font-medium rounded-xl" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.6)' }}>🐱 GitHub</button>
          </div>
          ...
          <div className="text-center space-y-2">
            <Link to="/forgot-password" className="text-sm" style={{ color: 'rgba(255,255,255,0.3)' }}>Forgot password?</Link>
