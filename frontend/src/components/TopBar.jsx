...
export default function TopBar() {
  ...
  return (
    <header className="h-14 flex items-center justify-between px-5"
      style={{ background: 'rgba(12,16,32,0.8)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2.5 pl-3" style={{ borderLeft: '1px solid rgba(255,255,255,0.08)' }}>
          <div className="w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold text-white btn-primary" style={{ padding: 0, minWidth: 32, height: 32 }}>
