...
function generateInvoiceHTML(invoice, items, org) {
  ...
  if (hasCGST) {
    summaryRows += `<tr style="font-style:italic"><td style="border-top:1px solid #ddd;padding:6px 10px;color:#000"></td><td colspan="6" style="border-top:1px solid #ddd;padding:6px 10px;text-align:right;font-weight:700;color:#000">CGST ${cgstRate.toFixed(1)}%</td><td style="border-top:1px solid #ddd;padding:6px 10px;text-align:right;font-weight:700;color:#000">&#8377;${formatIndian(cgstAmount)}</td></tr>`;
    summaryRows += `<tr style="font-style:italic"><td style="border-top:1px solid #ddd;padding:6px 10px;color:#000"></td><td colspan="6" style="border-top:1px solid #ddd;padding:6px 10px;text-align:right;font-weight:700;color:#000">SGST ${sgstRate.toFixed(1)}%</td><td style="border-top:1px solid #ddd;padding:6px 10px;text-align:right;font-weight:700;color:#000">&#8377;${formatIndian(sgstAmount)}</td></tr>`;
  }
  if (hasIGST || igstAmount > 0) {
    summaryRows += `<tr style="font-style:italic"><td style="border-top:1px solid #ddd;padding:6px 10px;color:#000"></td><td colspan="6" style="border-top:1px solid #ddd;padding:6px 10px;text-align:right;font-weight:700;color:#000">IGST ${igstRate.toFixed(1)}%</td><td style="border-top:1px solid #ddd;padding:6px 10px;text-align:right;font-weight:700;color:#000">&#8377;${formatIndian(igstAmount)}</td></tr>`;
  }
  ...
  summaryRows += `<tr style="border-top:1.5px solid #1a1a1a"><td style="padding:10px 10px;color:#000"></td><td colspan="3" style="font-weight:900;font-size:15px;padding:10px 10px;color:#000">Total</td><td style="font-weight:900;font-size:15px;padding:10px 10px;text-align:right;color:#000">${totalQty.toFixed(3)}</td><td style="padding:10px 10px"></td><td style="padding:10px 10px"></td><td style="font-weight:900;font-size:15px;padding:10px 10px;text-align:right;color:#000">&#8377;${formatIndian(invoice.total_amount)}</td></tr>`;

  let hsnRows = '';
  Object.entries(hsnMap).forEach(([hsn, d]) => {
    hsnRows += `<tr>
      <td style="border:1px solid #999;padding:6px 10px;font-weight:700;color:#000">${hsn}</td>
      <td style="border:1px solid #999;padding:6px 10px;text-align:right;font-weight:600;color:#000">${formatIndian(d.taxable)}</td>
      ${hasCGST ? `
        <td style="border:1px solid #999;padding:6px 10px;text-align:right;font-weight:600;color:#000">${d.cgstRate}%</td>
        <td style="border:1px solid #999;padding:6px 10px;text-align:right;font-weight:600;color:#000">${formatIndian(d.cgstAmt)}</td>
        <td style="border:1px solid #999;padding:6px 10px;text-align:right;font-weight:600;color:#000">${d.sgstRate}%</td>
        <td style="border:1px solid #999;padding:6px 10px;text-align:right;font-weight:600;color:#000">${formatIndian(d.sgstAmt)}</td>
      ` : `
        <td style="border:1px solid #999;padding:6px 10px;text-align:right;font-weight:600;color:#000">${d.igstRate}%</td>
        <td style="border:1px solid #999;padding:6px 10px;text-align:right;font-weight:600;color:#000">${formatIndian(d.igstAmt)}</td>
      `}
      <td style="border:1px solid #999;padding:6px 10px;text-align:right;font-weight:800;color:#000">${formatIndian(d.cgstAmt + d.sgstAmt + d.igstAmt)}</td>
    </tr>`;
  });
  ...
  * { box-sizing: border-box; }
  body { font-family: ${fontFamily}; background: #f2f2f2; margin: 0; padding: 20px; color: #000; font-weight: 600; }
...
<div class="invoice">
  ...
  <div style="display:grid;grid-template-columns:1.6fr 1fr 1fr;border-bottom:${bdr}">
    ...
    <div style="padding:16px 18px;border-right:${bdr}">
      ...
      <div style="font-weight:800;font-size:14px;margin-bottom:16px;line-height:1.3;color:#000">${invNum}</div>
      <div style="font-size:13px;color:#000;margin-bottom:2px;font-weight:700">Place of Supply:</div>
      <div style="font-weight:800;font-size:14px;line-height:1.3;color:#000">${placeOfSupply}</div>
    </div>
    <div style="padding:16px 18px">
      <div style="font-size:13px;color:#000;margin-bottom:2px;font-weight:700">Invoice Date:</div>
      <div style="font-weight:800;font-size:14px;line-height:1.3;color:#000">${invoiceDate}</div>
    </div>
  </div>
  <div style="display:grid;grid-template-columns:1fr 1fr;border-bottom:${bdr}">
    <div style="padding:14px 20px;border-right:${bdr};font-size:12.5px;line-height:1.5;color:#000">
      ...
      ${custGstin ? `<p style="margin:2px 0;font-weight:700;color:#000">GSTIN: ${custGstin}</p>` : ''}
  ...
  <table style="font-size:12.5px;border-bottom:${bdr};color:#000">
    <thead>
      ...
      <tr>
        ...
        ${hasCGST ? `<th style="border:1px solid #999;padding:4px 10px;text-align:right;background:#f0f0f0;font-weight:700;color:#000">Rate</th><th style="border:1px solid #999;padding:4px 10px;text-align:right;background:#f0f0f0;font-weight:700;color:#000">Amount</th>` : ''}
      </tr>
    </thead>
    <tbody>
      ${hsnRows}
      <tr style="font-weight:800;background:#f0f0f0;color:#000">
        ...
        ${hasCGST ? `
          ...
          <td style="border:1px solid #999;padding:6px 10px;text-align:right;color:#000">${formatIndian(cgstAmount)}</td>
          <td style="border:1px solid #999;padding:6px 10px;color:#000"></td>
          <td style="border:1px solid #999;padding:6px 10px;text-align:right;color:#000">${formatIndian(sgstAmount)}</td>
        ` : `<td style="border:1px solid #999;padding:6px 10px;color:#000"></td><td style="border:1px solid #999;padding:6px 10px;text-align:right;color:#000">${formatIndian(igstAmount)}</td>`}
        <td style="border:1px solid #999;padding:6px 10px;text-align:right;color:#000">${formatIndian(totalTax)}</td>
      </tr>
    </tbody>
  </table>
  ${isPaid ? `<div style="text-align:right;padding:10px 20px;border-bottom:${bdr};font-size:13px;color:#000;font-weight:800"><span style="color:#1a7d3a;font-weight:900">&#10004; Amount Paid</span><br>&#8377;${formatIndian(invoice.total_amount)} Paid</div>` : ''}
  <div style="display:grid;grid-template-columns:1.2fr 1fr 1fr;border-bottom:${bdr}">
    ...
    <div style="padding:16px 20px;border-right:${bdr};font-size:13px;color:#000">
      ...
      ${qrUrl ? `<img src="${qrUrl}" style="width:130px;height:130px;margin-top:6px">` : '<div style="width:130px;height:130px;border:1px solid #333;display:flex;align-items:center;justify-content:center;font-size:11px;color:#000;font-weight:700;margin-top:6px">QR CODE</div>'}
    </div>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr">
    <div style="padding:14px 20px;border-right:${bdr};font-size:12.5px;line-height:1.6;color:#000">
    ...
    <div style="padding:14px 20px;font-size:12.5px;line-height:1.6;color:#000">
  ...
  <div style="text-align:left;padding:8px 20px;font-size:11.5px;color:#000;border-top:${bdr};font-weight:600">
