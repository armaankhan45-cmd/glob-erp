...
// ═══════════════════════════════════════════════
function MonthView({ monthFullName, entry, monthlyBills, billsLoading }) {
      ...
      <div className="card card-premium" style={{ padding: '28px', textAlign: 'center' }}>
        ...
        {!hasAnyData ? (
          <>
            ...
            <p className="text-sm text-white/30">No sales invoices or purchase bills recorded in {monthFullName}</p>
          </>
        ) : isPayable ? (
          <>
